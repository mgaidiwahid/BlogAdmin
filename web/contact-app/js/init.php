   ...
   ?>
    ...
    <?php echo $jQueryPrefix; ?>.ajax({
	  ...
	  //alert(response);
	   ...
	   var result = '<div class="notification_error"><?php echo $form_notifications['mail_cannot_be_sent_e']; ?>'+ possible_error +'</div>';
       ...
       if(status == 0) { // Message sent
        ...
        <?php if(CUSTOM_THANK_YOU_URL === false) { ?>
          ...
          ?>
	          ...
	          var result = '<div class="notification_error"><?php echo $form_notifications['correct_errors_e']; ?> ';
		      ...
		      <?php echo $jQueryPrefix; ?>('label.error').remove();
              ...
              result += '<?php echo $form_notifications['security_code_e']; ?>';

			  } else if(<?php echo $jQueryPrefix; ?>.evalJSON(response).security_code == 2) {
			  <?php echo $jQueryPrefix; ?>('#security_code').addClass('error').removeClass('ok');
			  
			  result += '<?php echo $form_notifications['security_code_i_e']; ?>';
...
<?php echo $jQueryPrefix; ?>('#<?php echo $key; ?>').after('<label id="<?php echo $key; ?>_error" class="error"><?php echo $formFields[$key]['errors']['none']; ?></label>');
...
<?php echo $jQueryPrefix; ?>('#<?php echo $key; ?>').addClass('error').removeClass('ok').after('<label id="<?php echo $key; ?>_error_invalid" class="error"><?php echo $formFields[$key]['errors']['invalid']; ?></label>');
...
<?php echo $jQueryPrefix; ?>('#<?php echo $key; ?>').addClass('error').removeClass('ok').after('<label id="<?php echo $key; ?>_error_min_chars" class="error"><?php echo str_replace('[min_chars]', $min_chars, $formFields[$key]['errors']['min_chars']); ?></label>');
...
<?php echo $jQueryPrefix; ?>('#security_code').addClass('error').removeClass('ok');
<?php echo $jQueryPrefix; ?>('#sec_div_one').after('<label id="sc_error" class="error"><?php echo $form_notifications['security_code_e']; ?></label>');
	     ...
	     success: function(outData) { 
	      	          ...
	      	          if(outData != 1) {
	      	            ...
	      	            if(<?php echo $jQueryPrefix; ?>("#sc_error.error").length == 0) {
	      	                <?php echo $jQueryPrefix; ?>('#security_code').addClass('error').removeClass('ok');
	      	                <?php echo $jQueryPrefix; ?>('#sec_div_one').after('<label id="sc_error" class="error"><?php echo $form_notifications['security_code_i_e']; ?></label>');
...
<?php echo $jQueryPrefix; ?>("label[id$='_error']").addClass('styled');

<?php } ?>

if(<?php echo $jQueryPrefix; ?>("label.error").length > 0) { 
   ...
   <?php if(HIGHLIGHT_FIELD_ZONE == 1) { ?>
    ...
    <?php echo $jQueryPrefix; ?>.each(fields, function() {
	    ...
	    if(this == 'security_code') {
          ...
          <?php echo $jQueryPrefix; ?>('#' + this).focus(function() { <?php echo $jQueryPrefix; ?>(this).closest('div').addClass("highlighted"); })
				        .blur(function() { <?php echo $jQueryPrefix; ?>(this).closest('div').removeClass("highlighted"); });
	    }
