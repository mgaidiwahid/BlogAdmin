 ...
 * @ORM\Entity(repositoryClass="Od\MainBundle\Repository\AlbumRepository")
 */
class Album
{
    /**
    ...
    */
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Od\MainBundle\Entity\Image", cascade={"persist", "refresh"})
     */
    private $images;
	...
	public function addImage(Image $photo){
	...
	public function removeImage(Image $photo)
    {
		
    $this->tags->removeElement($photo);
    }
